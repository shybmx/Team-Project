...
public class AddCustomer extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        add.setIcon(new javax.swing.ImageIcon("C:\\Users\\shahzad\\Documents\\City univeristy\\Year 2\\Team Project\\Project\\GARITS\\data\\addUserIcon.png")); // NOI18N
        ...
        close.setBounds(1161, 6, 112, 149);
        ...
        jLabel13.setBounds(1161, 311, 11, 16);
        ...
        jLabel14.setBounds(0, 0, 1420, 430);
    ...
    private void addActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addActionPerformed
        ...
        String discount = insertDiscount.getText();
        Connection conn = null;
        PreparedStatement prestate = null;
        try{
            Class.forName("com.mysql.jdbc.Driver");
            conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/garits","root","");
            prestate = conn.prepareStatement("INSERT INTO `garits`.`customers` "
                    + "Values (?,?,?,?,?,?,?,?,?,?,?,?)");
